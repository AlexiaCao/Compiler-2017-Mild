...
public class BitXorInstruction extends BinaryInstruction {
    private BitXorInstruction(VirtualRegister target, Operand source1, Operand source2) {
    ...
    public static Instruction getInstruction(Operand target, Operand source1, Operand source2) {
        if (target instanceof VirtualRegister) {
            return new BitXorInstruction((VirtualRegister)target, source1, source2).rebuild();
        }
        throw new InternalError("BitXorInstruction:getInstruction.");
    }
