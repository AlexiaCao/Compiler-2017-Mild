...
public class GreaterThanOrEqualInstruction extends BinaryInstruction {
    private GreaterThanOrEqualInstruction(VirtualRegister target, Operand source1, Operand source2) {
    ...
    public static Instruction getInstruction(Operand target, Operand source1, Operand source2) {
        if (target instanceof VirtualRegister) {
            return new GreaterThanOrEqualInstruction((VirtualRegister)target, source1, source2).rebuild();
        }
        throw new InternalError("GreaterThanOrEqualInstruction:getInstruction");
    }
