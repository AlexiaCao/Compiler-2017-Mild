...
import BackEnd.ControlFlowGraph.Instruction.ArithmeticInstruction.BinaryInstruction.BitLeftShiftInstruction;
...
public class BitLeftShiftExpression extends BinaryExpression {
	private BitLeftShiftExpression(Type type, boolean isLeftValue, Expression left, Expression right) {
	...
	public static Expression getExpression(Expression left, Expression right) {
		if (left.type instanceof IntType && right.type instanceof IntType) {
			...
			return new BitLeftShiftExpression(IntType.getType(), false, left, right);
		}
	...
	public void emit(List<Instruction> instructions) {
		...
		instructions.add(BitLeftShiftInstruction.getInstruction(operand, left.operand, right.operand));
	}
}
