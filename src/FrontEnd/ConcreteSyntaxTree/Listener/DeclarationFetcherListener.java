...
public class DeclarationFetcherListener extends BaseListener {
    ...
    @Override
    public void exitVoidType(MildParser.VoidTypeContext ctx) {
        returnNode.put(ctx, VoidType.getType());
    }
    @Override
    public void exitIntType(MildParser.IntTypeContext ctx) {
        returnNode.put(ctx, IntType.getType());
    }

    @Override
    public void exitBoolType(MildParser.BoolTypeContext ctx) {
        returnNode.put(ctx, BoolType.getType());
    }

    @Override
    public void exitStringType(MildParser.StringTypeContext ctx) {
        returnNode.put(ctx, StringType.getType());
    }

    @Override
    public void exitClassType(MildParser.ClassTypeContext ctx) {
    ...
    @Override
    public void exitArrayType(MildParser.ArrayTypeContext ctx) {
